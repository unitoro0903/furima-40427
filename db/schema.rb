...
ActiveRecord::Schema[7.0].define(version: 2024_07_21_072929) do
  ...
  create_table "require_times", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "ship_fees", charset: "utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
